...
import "./App.css";
    ...
    const TEMPLATE_NAME = "Sale Agreement - LV"; //name of template stored on Openlaw - OpenLaw API Tutorial Sale Agreement
    const OPENLAW_USER = 'luisvid@gmail.com'; //add your Openlaw login email
    const OPENLAW_PASSWORD = '.20!VdqtP?13_Ol' //add your Openlaw password
    //create config 
    const openLawConfig = {
      server:URL, 
